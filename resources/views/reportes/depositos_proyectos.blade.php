	        ...
	        <div class="row mb-2">
	          <div class="col-sm-12">
	            <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Depositos por Proyectos</li>
	            </ol>
	          </div>
	        </div>
	      </div>
        ...
        <div class="card-header">
        	<div class="row">
        		<div class="col-sm-9 col-lg-10">
		          <h1 class="card-title">Depositos por Proyectos</h1>
        		</div>
        	</div>
        </div>
        <div class="card-body">
            <form action="{{route('reportes.depositos_proyectos')}}" method="POST">
                @csrf
                            ...
                            <table class="table table-striped table-bordered table-hover table-sm dt-responsive" id="dateTable1" style="width:100%;cursor:pointer">
                                ...
                                <tbody>
                                    @foreach($depositos as $deposito)
                                        <tr>
                                            <td>{{number_format($deposito->depositado)}}</td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td><strong>{{number_format($depositos->sum('depositado'))}}</strong></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
